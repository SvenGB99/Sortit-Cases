        ...
        return [
            ...
            'fields' => [
                ...
                "custom{$name}" => [
                    ...
                    'metadata' => [
                        'label' => trans('Custom %taxonomy%', ['%taxonomy%' => $taxonomy->labels->singular_name]),
                        'group' => 'Custom',
                        'fields' => [
                            'id' => [
                ...
                "custom{$base}" => [
                    ...
                    'metadata' => [
                        'label' => trans('Custom %taxonomies%', ['%taxonomies%' => $taxonomy->label]),
                        'group' => 'Custom',
                        'fields' => ($taxonomy->hierarchical ? [
                            'id' => [
                                'label' => trans('Parent %taxonomy%', ['%taxonomy%' => $taxonomy->labels->singular_name]),
                                'description' => trans('%taxonomies% are only loaded from the selected parent %taxonomy%.', ['%taxonomies%' => $taxonomy->label, '%taxonomy%' => $singular]),
                                'type' => 'select',
                                'default' => 0,
                                'options' => [
                                    ['value' => 0, 'text' => 'Root'],
                            ...
                            '_offset' => [
                                'description' => trans('Set the starting point and limit the number of %taxonomies%.', ['%taxonomies%' => $plural]),
                                'type' => 'grid',
                                'width' => '1-2',
                                'fields' => [
                                    'offset' => [
