        ...
        'render' => function ($node) {
            ...
            $content = Helper::renderTemplate(function () use ($node) {
                ...
                if (empty($node->props['show_headline'])) {
                    $filters[] = Helper::addFilter('woocommerce_product_related_products_heading', function () {}, 100);
                }
                ...
                $filters[] = Helper::addFilter('woocommerce_output_related_products_args', function ($args) use ($node) {
                    return array_merge($args, Arr::pick($node->props, ['posts_per_page', 'columns', 'orderby', 'order']));
                });
