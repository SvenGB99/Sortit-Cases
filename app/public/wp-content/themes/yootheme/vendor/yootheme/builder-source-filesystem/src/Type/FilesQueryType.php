                ...
                'files' => [
                    ...
                    'metadata' => [
                        ...
                        'fields' => [
                            ...
                            '_offset' => [
                                'description' => trans('Set the starting point and limit the number of files.'),
                                'type' => 'grid',
                                'width' => '1-2',
                                'fields' => [
                                    'offset' => [
                            ...
                            '_order' => [
                                'type' => 'grid',
                                'width' => '1-2',
                                'description' => trans('The Default order will follow the order set by the brackets or fallback to the default files order set by the system.'),
                                'fields' => [
                                    'order' => [
                                        'label' => trans('Order'),
                                        'type' => 'select',
